...
// This page handles serviceman registration only.
...
export default function ServiceManAuthPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (step === 2) {
      ...
      setLoading(true);
      try {
        await api.post("/auth/register/verify-otp/", { email: form.email, otp: form.otp });
        setStep(3);
      } catch (err: unknown) {
        const e = err as { response?: { data?: { detail?: string } } };
  ...
  return (
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        <h2 style={styles.title}>Join as ServiceMan</h2>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  logo:  { fontSize: 30, fontWeight: "bold", marginBottom: 20, color: "#fff" },
