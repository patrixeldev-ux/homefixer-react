...
export default function CustomerProducts() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Search, Category Filter & My Cart */}
<div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 mb-6">
  ...
  <input
    ...
    className="border rounded-lg px-4 py-2 w-full md:w-2/4 focus:outline-none focus:ring-2 focus:ring-orange-400"
    value={searchTerm}
  ...
  <select
    ...
    className="border rounded-lg px-4 py-2 w-full md:w-1/3 focus:outline-none focus:ring-2 focus:ring-orange-400"
  >
  ...
  {/* My Cart Button */}
  <button
    onClick={() => router.push('/customer/my-cart')}
    className="relative flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 
               hover:from-orange-600 hover:to-red-600 text-white font-semibold 
               px-6 py-2 rounded-lg shadow-md transition-all duration-300 w-full md:w-auto"
  >
    🛒 My Cart
